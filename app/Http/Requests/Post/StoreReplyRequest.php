...
class StoreReplyRequest extends FormRequest
{
    ...
    {
        return [
                'content.required_without' => 'balasan tidak boleh kosong',
                'media.required_without'   => 'setidaknya kirim 1 gambar apabila tidak mengisi balasan',
                'content.max'      => 'balasan maksimal 256 karakter',
